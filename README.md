Adds a quick search toggle to any page that corresponds to a single media title. This is on all supported websites, with the goal being to add this behavior on any page that meets that requirement. 
