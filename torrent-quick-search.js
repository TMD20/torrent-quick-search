...
if (infoparser===undefined){
  alert("Title Not Parsed")
  throw error("")

}
return document.querySelector(infoparser["title"]).textContent.trim()
}
...
async function doSearch(){
 ...
 try {
    ...
    data = await Promise.allSettled(indexers.map((e)=>fetchIndexer(e)));
    addNumbers()
    ...
    document.querySelector("#msgnode").textContent="Finished"
            ...
            alert(error)
            document.querySelector("#msgnode").textContent=error
...
async function fetchIndexer(indexerObj){
